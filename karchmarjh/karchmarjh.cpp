...
// karchmarjh.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CkarchmarjhApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CkarchmarjhApp

CkarchmarjhApp::CkarchmarjhApp()
{
...
// Единственный объект CkarchmarjhApp

CkarchmarjhApp theApp;


// Инициализация CkarchmarjhApp

BOOL CkarchmarjhApp::InitInstance()
{
